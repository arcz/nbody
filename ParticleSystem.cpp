...
void mThread(std::vector<glm::vec3>& mPositions,std::vector<float>& mMasses,std::vector<glm::vec3>& mAccelerations,unsigned start,unsigned end, unsigned i){
...
*/
    	ts[0] = std::thread(mThread,std::ref(mPositions),std::ref(mMasses),std::ref(mAccelerations),0,MAX_PARTICLES/4,i);
	ts[1] = std::thread(mThread,std::ref(mPositions),std::ref(mMasses),std::ref(mAccelerations),MAX_PARTICLES/4,MAX_PARTICLES/2,i);
	ts[2] = std::thread(mThread,std::ref(mPositions),std::ref(mMasses),std::ref(mAccelerations),MAX_PARTICLES/2,3*MAX_PARTICLES/4,i);
	ts[3] = std::thread(mThread,std::ref(mPositions),std::ref(mMasses),std::ref(mAccelerations),3*MAX_PARTICLES/4,MAX_PARTICLES,i);
